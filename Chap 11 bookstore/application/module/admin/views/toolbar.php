<?php 
    ...
    switch ($this->arrParam['action']) {
        case 'index':
            $strButton =  $btnNew . $btnPublish . $btnUnPublish  . $btnOrdering. '<li class="divider"></li>'  . $btnTrash;            
            break;
        case 'form':
            $strButton = $btnSave . $btnSaveClose . $btnSaveNew . '<li class="divider"></li>' . $btnCancel;            
            break;
